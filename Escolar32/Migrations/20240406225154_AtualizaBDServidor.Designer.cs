...
namespace Escolar32.Migrations
{
    ...
    [Migration("20240406225154_AtualizaBDServidor")]
    partial class AtualizaBDServidor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Escolar32.Models.Despesa", b =>
                {
                    ...
                    b.Property<int>("AnoDespesa")
                        .HasColumnType("int");

                    b.Property<DateTime>("DataDespesa")
                        .HasColumnType("datetime2");

                    b.Property<string>("DespesaDetalhe")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Escolar32.Models.Receita", b =>
                {
                    ...
                    b.Property<int>("AnoReceita")
                        .HasColumnType("int");

                    b.Property<DateTime>("DataReceita")
                        .HasColumnType("datetime2");

                    b.Property<int>("MesReceita")
                        .HasColumnType("int");

                    b.Property<string>("ReceitaDetalhe")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReceitaNome")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Escolar32.Models.Aluno", b =>
                {
                    ...
                    b.HasOne("Escolar32.Models.Receita", "Receita")
                        .WithMany()
